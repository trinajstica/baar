...
install:
	...
	install -Dm644 baar.desktop $(DESTDIR)/usr/share/applications/baar.desktop
	install -Dm644 baar.png $(DESTDIR)/usr/share/pixmaps/baar.png
	install -Dm644 baar.xml $(DESTDIR)/usr/share/mime/packages/baar.xml
	install -Dm644 baar.png $(DESTDIR)/usr/share/icons/hicolor/48x48/mimetypes/application-x-baar.png
	update-mime-database $(DESTDIR)/usr/share/mime || true
	gtk-update-icon-cache $(DESTDIR)/usr/share/icons/hicolor || true

UNINSTALL_FILES = \
	$(DESTDIR)$(PREFIX)/bin/baar \
	$(DESTDIR)/usr/share/applications/baar.desktop \
	$(DESTDIR)/usr/share/pixmaps/baar.png \
	$(DESTDIR)/usr/share/mime/packages/baar.xml \
	$(DESTDIR)/usr/share/icons/hicolor/48x48/mimetypes/application-x-baar.png
